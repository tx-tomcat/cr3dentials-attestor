...
export enum ServiceSignatureType {
  ...
  SERVICE_SIGNATURE_TYPE_APTOS = 2,
  UNRECOGNIZED = -1,
}
...
export function serviceSignatureTypeFromJSON(
  ...
  switch (object) {
    ...
    case 2:
    case "SERVICE_SIGNATURE_TYPE_APTOS":
      return ServiceSignatureType.SERVICE_SIGNATURE_TYPE_APTOS;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function serviceSignatureTypeToJSON(
  ...
  switch (object) {
    ...
    case ServiceSignatureType.SERVICE_SIGNATURE_TYPE_APTOS:
      return "SERVICE_SIGNATURE_TYPE_APTOS";
...
export const ClaimTunnelResponse: MessageFns<ClaimTunnelResponse> = {
  ...
  toJSON(message: ClaimTunnelResponse): unknown {
    ...
    if (message.signatures !== undefined) {
      obj.signatures = ClaimTunnelResponse_Signatures.toJSON(
        message.signatures
      );
    }
    return obj;
  ...
  fromJSON(object: any): RPCMessage {
    return {
      ...
      initResponse: isSet(object.initResponse)
        ? Empty.fromJSON(object.initResponse)
        : undefined,
